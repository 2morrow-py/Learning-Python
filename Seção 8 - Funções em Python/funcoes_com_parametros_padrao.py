...
# OBS: Se o usuário passar somente 1 argumento, este será atribuído ao parâmetro numero,
# e será calculado o quadrado deste número;
# Se o usuário passar 2 argumentos, o primeiro será atribuído ao parâmetro número
# e o segundo ao parâmetro potência. Então será calculado esta potência.
...
# OBS: Se tivermso uma variável local com o mesmo nome de uma variável global, a local
# terá preferência.

...
Poderiamos chamar este parâmetro de **xis, qualquer nome, mas
por conveção chamados de **kwargs

Este é só mais um parâmetro, mas diferente do *args que coloca os valores extras em
uma tupla, **kwargs exige que utilizemos parâmetros nomeados, e transforma esses
...
# OBS: Os parâmetros 8args e **kwargs não são obrigatórios.

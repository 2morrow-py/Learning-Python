...
Listas em Python funcionam como vetores/matrízes (arrays) em outras linguagens, com a diferena
...
# Podemos facilmete ordenar uma lista
lista1.sort()
print(lista1)
...
# OBS: Isso não substitui o valor inicial. Omesmo será deslocado para a direita da lista.
...
# Podemnos remover facilmente o último elemento de uma lista
...
# Exemplo 1:
# OBS: Por padrão, o split serapa os elementos da lista pelo espaço entre elas.
...
curso = ' '.join(lista6) # Estamos falando: Pega a lista6, coloca espaço entre cada elemento e transforma em uma string.
print(curso)

curso = '$'.join(lista6)# Estamos falando: Pega a lista6, coloca cifrão entre cada elemento e transforma em uma string.
print(curso)

# Podemos realmente colocar qualquer tipo de dado em uma lista, inclusive misturando esses dados.
lista6 = [1, 2.34, True, 'Geek', 'd', [1, 2, 3], 4551542541525]
print(lista6)
print(type(lista6))
...
soma = 0 # 0 para numeros e '' para strings
...
# Para entender melhor o índice negativo, pense na lista como um círculo, onde o final de um elemento está
# ligado ao início da lista
...
print(numeros.index(8, 3, 6)) # Buscar o valor 8 entre os índices 3 a 6
...
print(lista[1:]) # Iniciando no índice 1 e pegando todos os elementos restantes, pode usar [::]

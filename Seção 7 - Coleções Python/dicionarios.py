...
receita.update(novo_dado)  # receita.update({'mais': 500})
...
# CONCLUSÃO 1: A forma de acionar novos elementos ou atualizar dados em um diconário é a mesma.
...
# Desta forma, facilmente adiconamos ou removemos produtos no carrinho e em cada produto
# podemos ter a certeza sobre cada informação.

# Métodos de diconários.
...
# Ele vai gerar para cada valor do iterável uma chave e irá atribuir a esta chave o valro informado.
